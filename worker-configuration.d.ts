...
interface Env {
  ...
  // Text-to-Image app AI binding
  TEXT_TO_IMAGE_AI: Ai;

  // Multiplayer Globe app bindings (if any)
  GLOBE_KV?: KVNamespace;

  // D1 Database
  D1_COMMENTS?: D1Database;
  D1_USERS?: D1Database;

  // Authentication template KV/DB
  AUTH_KV?: KVNamespace;
...
// Optional interface extensions for AI type
interface Ai {
  // You can define additional helpers if needed
  generate?: (prompt: string, options?: Record<string, any>) => Promise<any>;
}

// Global types for Worker environment (already included in @cloudflare/workers-types)
declare var env: Env;
declare var __STATIC_CONTENT_MANIFEST: string;
/* eslint-disable */
